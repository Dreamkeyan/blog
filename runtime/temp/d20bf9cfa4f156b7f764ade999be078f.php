<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\WWW\blog\public/../application/admin\view\adv\index.html";i:1483498391;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <table class="table table-hover text-center">
      <tr>
       ...
       <?php if($review != ""): foreach($review as $value): ?>
          ...
          <form id="<?php echo $value['ID']; ?>" name="<?php echo $value['ID']; ?>">
        ...
        <tr>
          ...
          <td><?php echo $value['reviewid']; ?></td>  
           <td><?php echo date("y-m-d",$value['reviewdate']); ?></td>         
          <td><input type="button" onclick="ale('<?php echo $value['centent']; ?>')" value="<?php echo mb_substr($value['centent'],0,7,'utf-8'); ?>" style="border: 0;text-align: center;background-color: #fff" ></td>
